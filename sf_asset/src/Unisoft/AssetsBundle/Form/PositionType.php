...
//            ->add('positionNo')
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Unisoft\AssetsBundle\Entity\Position',
    ...
    {
        return 'unisoft_assetsbundle_positiontype';
    }
}
...
class AddNameFieldSubscriber implements EventSubscriberInterface
{
    ...
    public function preSetData(DataEvent $event)
    {
        ...
        $field_op=array();
        $field_op['label']='Job Number';
        if ($data->getId())
            $field_op['read_only']=true;
        
        $form->add($this->factory->createNamed('positionNo','text', null, $field_op));
//        if (!$data->getId()) {
